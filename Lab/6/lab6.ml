...
let f (u: int): int =
    ...
    let y = 5 in
    let z = 6 in
        print_string "Local frame for function f:\n";
        print_string "u = ";
        print_int u;
        print_char '\n';
        print_string "a = ";
        ...
        print_int z;
        print_char '\n';
        print_string "Global frame for function f:\n";
        print_string "x = ";
        print_int x;
        print_char '\n';
        0
...
let g (u: int): int =
    ...
    let h (v: int): int =
        ...
        let b = 11 in
        let z = 12 in
            print_string "Local frame for function h:\n";
            print_string "v = ";
            print_int v;
            print_char '\n';
            print_string "a = ";
            ...
            print_int z;
            print_char '\n';
            print_string "Global frame for function h:\n";
            print_string "u = ";
            print_int u;
            print_char '\n';
            print_string "x = ";
            ...
            print_int w;
            print_char '\n';
            print_string "Outer global frame for function h:\n";
            print_string "y = ";
            print_int y;
            print_char '\n';
            0
    in
        print_string "Local frame for function g:\n";
        print_string "u = ";
        print_int u;
        print_char '\n';
        print_string "a = ";
        ...
        print_int w;
        print_char '\n';
        print_string "Global frame for function g:\n";
        print_string "y = ";
        print_int y;
        print_char '\n';
        print_string "z = ";
        print_int z;
        print_char '\n';
        print_string "Calling function h...\n";
        h (-3)
in
    f (-1);
    g (-2);
...
let power_tr (a: int) (b: int) =
    if b = 0 then
        ...
        let rec recursion (a: int) (b: int) (accumulator: int) =
            match b with
            | 0 -> accumulator
            | _ -> recursion a (b - 1) (accumulator * a)
    in
        recursion a b 1
